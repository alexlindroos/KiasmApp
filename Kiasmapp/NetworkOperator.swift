...
class NetworkOperator: NSURLSession{
    ...
    func getAreaData(){
        ...
        let url = NSURL(string: "http://10.112.220.21:8080/Kiasmapp-backEnd/webresources/Area")
    ...
    func getProductData(){
        ...
        let url = NSURL(string: "http://10.112.220.21:8080/Kiasmapp-backEnd/webresources/Products")
    ...
    func postData(tulos:String){
        ...
        request.URL = NSURL(string: "http://10.112.220.21:8080/Kiasmapp-backEnd/webresources/Visits")
